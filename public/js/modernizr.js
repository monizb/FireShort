...
!function(e, n, t) {
    ...
    for (var c in x)
      if (x.hasOwnProperty(c)) {
        ...
        for (o = r(n.fn, "function") ? n.fn() : n.fn, a = 0; a < e.length; a++)
          ...
          1 === i.length
              ? Modernizr[i[0]] = o
              : (!Modernizr[i[0]] || Modernizr[i[0]] instanceof Boolean ||
  ...
  function s() {
    return "function" != typeof n.createElement
               ...
               : b ? n.createElementNS.call(n, "http://www.w3.org/2000/svg",
                                            arguments[0])
  ...
  function i(e) {
    return e
        .replace(/([a-z])-([a-z])/g,
                 function(e, n, t) { return n + t.toUpperCase() })
        .replace(/^-/, "")
  }
  function c() {
    var e = n.body;
  ...
  function l(e, t, r, o) {
    ...
    return a = s("style"), a.type = "text/css", a.id = "s" + f,
           (p.fake ? p : u).appendChild(a), p.appendChild(u),
           a.styleSheet ? a.styleSheet.cssText = e
                        : a.appendChild(n.createTextNode(e)),
           u.id = f,
           p.fake && (p.style.background = "", p.style.overflow = "hidden",
                      d = w.style.overflow, w.style.overflow = "hidden",
                      w.appendChild(p)),
           i = t(u, e),
           p.fake ? (p.parentNode.removeChild(p), w.style.overflow = d,
                     w.offsetHeight)
  ...
  function p(e) {
    return e
        .replace(/([A-Z])/g, function(e, n) { return "-" + n.toLowerCase() })
        .replace(/^ms-/, "-ms-")
  }
  function m(n, r) {
    var o = n.length;
    ...
    try {
      (n = !!e.canPlayType) &&
          (n = new Boolean(n),
           ...
           n.mp3 =
               e.canPlayType('audio/mpeg; codecs="mp3"').replace(/^no$/, ""),
           n.opus =
  ...
  Modernizr.addTest("touchevents", function() {
    ...
    if ("ontouchstart" in e || e.DocumentTouch && n instanceof DocumentTouch)
      ...
      var r = [
        "@media (", C.join("touch-enabled),("), "heartz", ")",
  ...
  var k = function(n) {
    ...
    if (!n)
      return !1;
    if (n = n.replace(/^@/, ""),
        r = n.replace(/-/g, "_").toUpperCase() + "_RULE", r in a)
      return "@" + n;
    for (var s = 0; o > s; s++) {
  ...
  Modernizr._q.unshift(function() { delete j.style }),
      Modernizr.addTest(
          "video",
          function() {
            var e = s("video"), n = !1;
              ...
              (n = !!e.canPlayType) &&
                  (n = new Boolean(n),
                   n.ogg = e.canPlayType('video/ogg; codecs="theora"')
                               .replace(/^no$/, ""),
                   n.h264 = e.canPlayType('video/mp4; codecs="avc1.42E01E"')
                                .replace(/^no$/, ""),
                   n.webm = e.canPlayType('video/webm; codecs="vp8, vorbis"')
                                .replace(/^no$/, ""),
                   n.vp9 = e.canPlayType('video/webm; codecs="vp9"')
                               .replace(/^no$/, ""),
                   n.hls = e.canPlayType(
      ...
      T.testAllProps = g, T.testAllProps = y,
      ...
      Modernizr.addTest("cssfilters",
                        function() {
                          ...
                          return e.style.cssText = C.join("filter:blur(2px); "),
                                 !!e.style.length && (n.documentMode === t ||
                                                      n.documentMode > 9)
                        }),
