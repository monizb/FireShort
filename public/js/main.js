...
// will be used for IE10/IE11 detection (Mozilla/5.0 (compatible; MSIE 10.0;
// Windows NT 6.2; Trident/6.0; rv:11.0)) const doc = document.documentElement;
...
const ssSearch = function() {
  ...
  searchTrigger.addEventListener('click', function(e) {
    ...
    setTimeout(
        function() { searchWrap.querySelector('.search-field').focus(); }, 100);
  });
  ...
  closeSearch.addEventListener('click', function(e) {
    ...
    if (siteBody.classList.contains('search-is-visible')) {
      ...
      setTimeout(
          function() { searchWrap.querySelector('.search-field').blur(); },
          100);
    }
  });
  ...
  searchField.addEventListener('click', function(e) { e.stopPropagation(); })
...
const ssSlickSlider = function() {
  ...
  function ssRunHomeSlider() {
    ...
    $('.s-home__arrow-prev')
        .on('click', function() { $heroSlider.slick('slickPrev'); });

    $('.s-home__arrow-next')
        .on('click', function() { $heroSlider.slick('slickNext'); });
...
const ssSmoothScroll = function() {
  $('.smoothscroll').on('click', function(e) {
    ...
    $('html, body')
        .stop()
        .animate({'scrollTop' : $target.offset().top}, cfg.scrollDuration,
                 'swing')
        .promise()
        .done(function() { window.location.hash = target; });
  });
};
