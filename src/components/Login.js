...
class Login extends Component {
  ...
  render() {
    ...
    if (isAuthenticated) {
      ...
      return (
          <div className = "Container"><div className = "contain-paper">
          <div className = "signin-signup">
          <form action = "" className = "sign-in-form"><br>
          </br>
                    <h2 className={classes.title}>LOGIN</h2><br>
          </br>
    ...
    <br />< button
    type = "submit"
    className = "submit" > <MuiThemeProvider theme = {theme}>{
                               isLoading && !loginError ? (< CircularProgress
